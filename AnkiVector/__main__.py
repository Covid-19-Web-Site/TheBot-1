...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="➕ Add Sally To Your Group ➕", url="t.me/NipunGroupBot?startgroup=true"
        ),
    ],
]
...
Support them  [AV Owner](t.me/Damantha_Jasinghe)"""
...
def AnkiVector_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n Join [Sally Updates](https://t.me/TheSallyUpdates) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [Sally Support](https://t.me/TheSallySupport).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [Sally Brother](https://t.me/TheSallyBot)."
