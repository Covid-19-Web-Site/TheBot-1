...
from Sinderella import pbot
from Sinderella import BOT_ID, MONGO_DB_URI
...
async def locks_dfunc(_, message):
   ...
   if len(message.command) != 2:
      return await lol.edit("I only recognize `/tagalert on` and `/tagalert off` only. 👀")
